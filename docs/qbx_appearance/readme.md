...
!!! info "Mirrored from GitHub"
    This page mirrors the [qbx_appearance README](https://github.com/Epixx1337/qbx_appearance#readme) and is refreshed automatically.
...
![Studio](https://raw.githubusercontent.com/Epixx1337/qbx_appearance/main/docs/media/studio-batch.png)

**Tattoos** with the full 840-entry base game catalogue, stacking, layer
ordering and per-tattoo opacity for sleeve builds.

![Tattoos](https://raw.githubusercontent.com/Epixx1337/qbx_appearance/main/docs/media/editor-tattoos.jpg)
...
![Outfits and a job locker](https://raw.githubusercontent.com/Epixx1337/qbx_appearance/main/docs/media/editor-outfits.jpg)
...
![Ped models](https://raw.githubusercontent.com/Epixx1337/qbx_appearance/main/docs/media/editor-ped-models.jpg)

More demo footage: [docs/media/demo-2.mp4](https://raw.githubusercontent.com/Epixx1337/qbx_appearance/main/docs/media/demo-2.mp4)
...
5. Generate thumbnails on a dev client: `/screenshotclothing`,
   ...
   [docs/studio.md](studio.md) — including the one client convar the
...
| doc | covers |
| --- | --- |
| [docs/config.md](config.md) | every config option |
| [docs/editor.md](editor.md) | the editor UI, camera, undress toggles, sections |
| [docs/studio.md](studio.md) | screenshot studio commands, framing presets, capture pipeline |
| [docs/outfits.md](outfits.md) | outfits, job/gang presets, sharing, bag & clothing items |
| [docs/migration.md](migration.md) | moving off illenium-appearance / qb-clothing, with the qbx_core patches |
| [docs/cdn.md](cdn.md) | serving thumbnails from a CDN instead of the resource download |
| [docs/events.md](events.md) | events, exports, commands, compatibility surface |
| [docs/items.md](items.md) | ox_inventory item definitions |
| [docs/schema.md](schema.md) | database schema |
| [docs/conflicts.md](conflicts.md) | known conflicts (qbx_radialmenu clothing commands) |
| [docs/internals.md](internals.md) | engine constraints the implementation works around |
