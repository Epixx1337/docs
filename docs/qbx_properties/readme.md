...
!!! info "Mirrored from GitHub"
    This page mirrors the [qbx_properties README](https://github.com/Epixx1337/qbx_properties#readme) and is refreshed automatically.
...
[▶ Watch: creating a property](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/creating-a-property.mp4)
...
[▶ Watch: the furniture editor](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/furniture-editor.mp4)
...
[▶ Watch: the housing tablet](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/housing-tablet.mp4)
...
[▶ Watch: utilities](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/utilities.mp4)
...
[▶ Watch: breaching and wall colours](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/breaching-wall-colour.mp4)

**Police raid** — starting a raid with a warrant at the receptionist, then going through the unit and robbing the safe.

[▶ Watch: a police raid](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/police-raid.mp4)
...
![Listing detail](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/market-listing.png)
...
![Interior pick](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/new-property-interiors.png)
...
![Point capture](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/new-property-mlo.png)
...
![Review](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/new-property-review.png)
...
![Creating in the world](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/new-property-ingame.png)

All of it happens standing at the property, not in a config file.

### Manage

![Property list](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/manage.png)

Every property on the server as a card with its photo, status and owner, searchable and filterable.

![Property details](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/manage-details.png)
...
![Buildings tab](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/buildings.png)
...
![Tablet utilities](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/tablet-utilities.png)
...
![Tablet upgrades](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/tablet-upgrades.png)
...
![Creator start](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/mlo-creator-start.png)
...
![Creator capture](https://raw.githubusercontent.com/Epixx1337/qbx_properties/main/.github/media/mlo-creator.png)
...
**Properties**
- Pooled IPL apartments (Del Perro, Integrity Way, Richard Majestic, Tinsel Towers) plus multi-unit apartment buildings with per-floor rooms, doorbells and shared parking garages — the Wiwang Hotel, the four Prodigy towers ([docs/prp-apartments.md](prp-apartments.md)) and the Starlite Motel ([docs/starlite-motel.md](starlite-motel.md)) ship preconfigured
- Garages register with qbx_garages by default or bridge to jg-advancedgarages, cd_garage or okokGarage through one config option — see [docs/garage-systems.md](garage-systems.md)
- Phone home apps hook in through secured exports (list homes, waypoint, lock doors, manage keys) — drop-in lb-phone files and an sd-phone adapter ship in [docs/phone-integrations.md](phone-integrations.md)
- Property types (residential, commercial, warehouse, gang with group access), per-type purchasable upgrades (stash and key limits, wiring, security alerts, a second garage, mood lighting), breaker tripping with electrician repairs, escrowed offers and realtor-placed mailboxes — see [docs/upgrades-and-types.md](upgrades-and-types.md)
...
- Inventory items can become furniture: scripts register their item and the player places it inside their property, metadata intact, with a pickup button in the editor to take it back. The crafting bench uses this — see [docs/placeable-items.md](placeable-items.md)
...
- The market UI can be embedded in laptop and tablet resources (fd_laptops and similar), with `/housing` optionally disabled — see [docs/third-party-ui.md](third-party-ui.md)
...
**1. The hook system.** Copy [docs/ox_doorlock/hooks.lua](https://github.com/Epixx1337/qbx_properties/blob/main/docs/ox_doorlock/hooks.lua) into ox_doorlock's `server/` folder, then wire it into `server/main.lua`. At the top of the file:
...
- `housingCommand` (shared) — `false` removes the `/housing` command; the UI stays reachable through the `openHousing` export or an embedded app, see [docs/third-party-ui.md](third-party-ui.md).
- `garageSystem` (shared) — `'qbx'` uses qbx_garages; other values bridge property and apartment garages to third-party garage scripts, see [docs/garage-systems.md](garage-systems.md). `prettyGarageNames` makes bridged systems show the plain property name instead of `property_fudge_ln_4`-style ids — fresh servers only, see the doc for the migration note.
...
- `propertyTypes` / `upgrades` / `keyholderLimit` / `electricity` / `mailbox` / `rentGraceHours` (shared) — property types, the upgrade catalog, breaker tripping and mailbox settings, see [docs/upgrades-and-types.md](upgrades-and-types.md).
